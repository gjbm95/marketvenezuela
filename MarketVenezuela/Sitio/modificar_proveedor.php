...
<div id="apDiv30">  </div>
<div class="Estilo8" id="apDiv31">Modificar Proveedor </div>
<div id="apDiv52"><img src="Imagenes/Figura - Sucursal1.png" width="100%" height="182" /></div>
<div id="apDiv58"><strong><a href="gestion_proveedores.php">Inicio</a></strong></div>
<div class="Estilo6" id="apDiv63">
  <p>Razon Social :</p>
</div>
<div id="apDiv64">
...
<div class="Estilo6" id="apDiv67">	RIF:</div>
<div id="apDiv68">
  <form id="form3" name="form3" method="post" action="">
    <input name="textfield2" type="text" id="textfield2" size="30" />
  </form>
</div>
<div class="Estilo6" id="apDiv69">Dirección Geográfica:</div>
<div id="apDiv70">
...
<div id="apDiv74">
  <form id="form8" name="form8" method="post" action="">
    <div align="center">
      <input type="reset" name="button" id="button" value="Modificar Proveedor" />
    </div>
  </form>
</div>
<div id="apDiv75"></div>
<div id="apDiv76"></div>
<div id="apDiv77"><strong>Logo</strong></div>
<div id="Layer1"><span class="Estilo6">Denominacion Comercial: </span></div>
<div id="Layer2">
  <input name="textfield22" type="text" id="textfield22" size="30" />
</div>
<div id="Layer3"><span class="Estilo6">Rubro:</span></div>
<div id="Layer4">
  <select name="select5" id="select5">
    <option>Seleccione Rubro</option>
        </select>
</div>
<div class="Estilo6" id="Layer5">Pagina Web: </div>
<div id="Layer6"></div>
<div id="Layer7">
...
<div id="Layer8">
  <input name="textfield222" type="text" id="textfield222" size="30" />
</div>
<div class="Estilo6" id="Layer9">Status:</div>
<div id="Layer10">
