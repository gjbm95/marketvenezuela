...
<div id="apDiv30">  </div>
<div class="Estilo8" id="apDiv31">Agregar Departamento</div>
...
<div class="Estilo6" id="apDiv63">Nombre del departamento:</div>
<div id="apDiv64">
...
<div id="apDiv74">
  <form id="form8" name="form8" method="post" action="">
    <div align="center">
      <input type="reset" name="button" id="button" value="Agregar Departamento" />
    </div>
  </form>
</div>
<div id="apDiv75"></div>
