...
<div id="apDiv30">  </div>
<div class="Estilo8" id="apDiv31">
  <p>Datos del Producto </p>
</div>
<div id="apDiv52"><img src="Imagenes/Figura - Sucursal1.png" width="100%" height="182" /></div>
<div id="apDiv58"><strong><a href="Visualizar_productos.php">Inicio</a></strong></div>
<div id="apDiv75"></div>
<div id="Layer1">
  <p class="Estilo6">Nombre del producto: </p>
  <p class="Estilo6">Precio:</p>
  <p class="Estilo6">Codigo:</p>
  <p class="Estilo6">Cantidad vendida: </p>
  <p class="Estilo6">Cantidad disponible: </p>
  <p class="Estilo6">Status:</p>
  <p class="Estilo6">Ubicación:</p>
</div>
<div id="Layer3"></div>
</body>
</html>
