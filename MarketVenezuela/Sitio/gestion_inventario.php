...
#Layer1 {
	...
	height:54px;
	z-index:45;
	background-image: url(Imagenes/Boton%20-%20);
}
#Layer2 {
	position:absolute;
	left:9%;
...
<div class="Estilo2" id="apDiv9">Contraseña:</div>
<div id="apDiv10">
  <label>
  <input type="password" name="contrasena" id="contrasena" />
  </label>
</div>
<div id="apDiv11"><img src="../Sitio/Imagenes/barra_azul.png" alt="" width="100%" height="102" /></div>
<div id="apDiv12"><img src="../Sitio/Imagenes/barra_menu.png" alt="" width="100%" height="47" /></div>
<div id="apDiv14"></div>
<div id="apDiv15"></div>
...
<div id="apDiv30">  </div>
<div class="Estilo8" id="apDiv31">Gestión de Inventario </div>
<div id="apDiv43"></div>
<div id="apDiv44">
  <div align="center"><img src="Imagenes/barra_menu.png" width="22" height="134" /></div>
</div>
<div class="Estilo9" id="apDiv45">Información del Departamento:</div>
<div id="apDiv46">
  <p class="Estilo6"> Este departamento se encarga del gestionamiento del inventario de esta sucursal. En esta sección se podrá agregar, modifcar, o eliminar productos y despachos. </p>
  <p class="Estilo6">&nbsp;</p>
</div>
<div class="Estilo10" id="apDiv47">
  <div align="center"><a href="index.php"></a>Menu Principal </div>
</div>
<div id="apDiv52"><img src="Imagenes/Figura - Sucursal1.png" width="100%" height="167" /></div>
<div id="apDiv56"><a href="agregar_producto.php"><img src="Imagenes/Boton - AgregarProducto.png" width="255" height="67" border="0" /></a></div>
<div id="apDiv57"><a href="modificar_producto.php"><img src="Imagenes/Boton - ModificarProducto.png" width="255" height="67" border="0" /></a></div>
<div id="apDiv59"><a href="Visualizar_productos.php"><img src="Imagenes/Boton - VisualizarProductos.png" width="255" height="67" border="0" /></a></div>
<div id="Layer1"><a href="gestion_proveedores.php"><img src="Imagenes/Boton - GestionarProveedores.png" width="255" height="67" border="0" /></a></div>
<div id="Layer2"><a href="gestion_marcas.php"><img src="Imagenes/Boton - GestonarMarcas.png" width="255" height="67" border="0" /></a></div>
</body>
</html>