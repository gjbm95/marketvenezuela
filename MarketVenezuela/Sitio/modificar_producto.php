...
<div id="apDiv30">  </div>
<div class="Estilo8" id="apDiv31">Modificar Producto </div>
<div id="apDiv52"><img src="Imagenes/Figura - Sucursal1.png" width="100%" height="182" /></div>
<div id="apDiv58"><strong><a href="gestion_inventario.php">Inicio</a></strong></div>
<div class="Estilo6" id="apDiv63">Nombre del producto: </div>
<div id="apDiv64">
  <form id="form1" name="form1" method="post" action="">
    <input name="textfield" type="text" id="textfield" size="30" />
  </form>
</div>
<div class="Estilo6" id="apDiv67"> Codigo del producto:	</div>
<div id="apDiv68">
  <form id="form3" name="form3" method="post" action="">
    <input name="textfield2" type="text" id="textfield2" size="30" />
  </form>
</div>
<div class="Estilo6" id="apDiv69">Tipo de producto: </div>
<div id="apDiv70">
...
<div id="apDiv74">
  <form id="form8" name="form8" method="post" action="">
    <div align="center">
      <input type="reset" name="button" id="button" value="Modificar Producto" />
    </div>
  </form>
</div>
<div id="apDiv75"></div>
<div id="apDiv76"></div>
<div id="apDiv77"><strong>Descripción:</strong></div>
<div id="apDiv78">
  <form id="form2" name="form2" method="post" action="">
    <textarea name="textarea" id="textarea" cols="40" rows="8"></textarea>
  </form>
</div>
<div class="Estilo6" id="Layer2">Precio:</div>
<div id="Layer3">
  <input name="textfield22" type="text" id="textfield22" size="30" />
</div>
<div id="Layer4"><span class="Estilo6">Ubicacion del producto: </span></div>
<div id="Layer5">
  <select name="select2" id="select2">
    <option>Seleccione pasillo</option>
  </select>
</div>
<div class="Estilo6" id="Layer8">Marca</div>
<div id="Layer9">
  <select name="select4" id="select4">
    <option>Seleccione marca</option>
  </select>
</div>
<div class="Estilo6" id="Layer10">Status</div>
<div id="Layer11">
