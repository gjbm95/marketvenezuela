...
<div id="apDiv30">  </div>
<div class="Estilo8" id="apDiv31">Perfil de Cliente</div>
<div id="apDiv43"></div>
<div id="apDiv44">
  <div align="center"><img src="Imagenes/Figura - Usuario.png" width="225" height="221" /></div>
</div>
<div class="Estilo9" id="apDiv45">Datos del Cliente:</div>
<div id="apDiv46">
  <p class="Estilo6">Nombres y Apellidos: </p>
  <p class="Estilo6">Edad:</p>
  <p class="Estilo6">Cédula de Identidad:</p>
</div>
<div class="Estilo10" id="apDiv47">
  <div align="center">Menu Principal</div>
</div>
<div id="apDiv48"><img src="Imagenes/Boton - RealizarCompra.png" width="255" height="67" /></div>
<div id="apDiv49"><a href="vercarnet.php"><img src="Imagenes/Boton - VerCarnet.png" width="255" height="67" /></a></div>
<div id="apDiv50"><a href="registro.php"><img src="Imagenes/Boton - ModificarCuenta.png" width="255" height="67" /></a></div>
<div id="apDiv51"><a href="vercompras.php"><img src="Imagenes/Boton - VerCompras.png" width="255" height="67" /></a></div>
<div id="apDiv52"><img src="Imagenes/Figura - Sucursal1.png" width="100%" height="182" /></div>
<div id="apDiv53"><img src="Imagenes/Figura - PublicidadMicrosoft.jpg" width="100%" height="247" /></div>
<div id="apDiv54"><img src="Imagenes/publi5.png" width="100%" height="247" /></div>
<div id="apDiv55">
  <p class="Estilo6">RIF:</p>
  <p class="Estilo6">Correo Electrónico:</p>
  <p class="Estilo6">Dirección:</p>
</div>
<div id="apDiv58"><strong><a href="perfil_cliente.php">Inicio</a></strong></div>
</body>
</html>