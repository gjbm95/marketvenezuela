...
<div id="apDiv30">  </div>
<div class="Estilo8" id="apDiv31">Agregar Marca  </div>
<div id="apDiv52"><img src="Imagenes/Figura - Sucursal1.png" width="100%" height="182" /></div>
<div id="apDiv58"><strong><a href="gestion_marcas.php">Inicio</a></strong></div>
...
<div class="Estilo6" id="apDiv67"> Descripcion:	</div>
<div id="apDiv68">
  <form id="form3" name="form3" method="post" action="">
    <textarea name="textfield2" cols="40" rows="10" id="textfield2"></textarea>
  </form>
</div>
<div id="apDiv74">
  <form id="form8" name="form8" method="post" action="">
    <div align="center">
      <input type="reset" name="button" id="button" value="Agregar Marca" />
    </div>
  </form>
</div>
<div id="apDiv75"></div>
...
<div class="Estilo6" id="Layer5">Proveedor:</div>
<div id="Layer6"></div>
<div id="Layer8">
