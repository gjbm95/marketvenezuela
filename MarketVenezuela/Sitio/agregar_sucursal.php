...
<div id="apDiv30">  </div>
<div class="Estilo8" id="apDiv31">Agregar Sucursal</div>
...
<div class="Estilo6" id="apDiv63">Nombre de la Sucursal:</div>
<div id="apDiv64">
...
<div id="apDiv74">
  <form id="form8" name="form8" method="post" action="">
    <div align="center">
      <input type="reset" name="button" id="button" value="Agregar Sucursal" />
      </div>
  </form>
</div>
<div id="apDiv75"></div>
